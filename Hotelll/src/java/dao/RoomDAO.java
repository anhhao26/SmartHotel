...
import com.smarthotel.model.RoomImage;
...
public class RoomDAO {
    ...
    public Room findByRoomNumber(String roomNumber) {
        ...
        try {
            // ĐÃ FIX: Ép buộc dùng LEFT JOIN FETCH cho cả images và roomType
    ...
    public List<Room> findAllRooms() {
        ...
        try {
            ...
            em.clear();
            // ĐÃ FIX: Ép buộc dùng LEFT JOIN FETCH để không bỏ sót phòng trống ảnh
