                ...
                <form action="products" method="POST" id="importForm" class="space-y-8 relative z-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 bg-hotel-cream/50 border border-hotel-gold/5 p-5 rounded-2xl opacity-60">
                            ...
                            <span class="text-sm font-bold text-hotel-muted uppercase tracking-widest">${product.unit}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="number" name="quantityToAdd" min="1" placeholder="0" class="w-full bg-hotel-cream border border-hotel-gold/10 rounded-2xl pl-6 pr-20 py-5 text-lg font-bold text-hotel-text tracking-widest outline-none focus:ring-4 focus:ring-hotel-gold/10 focus:border-hotel-gold transition-all" required />
                            <span class="absolute right-6 top-1/2 -translate-y-1/2 text-sm font-bold text-hotel-gold/40 uppercase">${product.unit}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="number" name="newCostPrice" value="${product.costPrice}" class="w-full bg-white border-2 border-emerald-600/10 rounded-2xl pl-6 pr-20 py-5 text-lg font-bold text-emerald-700 tracking-widest outline-none focus:ring-4 focus:ring-emerald-600/10 focus:border-emerald-600 transition-all" required />
                            <span class="absolute right-6 top-1/2 -translate-y-1/2 text-sm font-bold text-emerald-600/40 uppercase">VND</span>
                        </div>
                        <p class="text-sm text-emerald-600/60 font-bold italic tracking-wide"><span class="material-symbols-outlined text-sm align-middle mr-1">check_circle</span> Hệ thống sẽ tự động cập nhật giá vốn trung bình</p>
                    </div>
                    ...
                    <div class="flex gap-6 pt-10">
                        ...
                        <button type="submit" id="submitBtn" class="flex-[2] py-5 rounded-2xl bg-hotel-gold text-white text-base font-bold uppercase tracking-[0.3em] shadow-xl shadow-hotel-gold/30 hover:bg-hotel-text transition-all active:scale-95 flex items-center justify-center gap-2">
